...
export default observer(function IngotsOverview() {
  ...
  useEffect(() => {
    const fetchData = async () => await store.metalsStoreClient.loadIngots();
  ...
  const title = response.seo
    ? response.seo.title
    : `Achat en Ligne Lingots et Lingotins Or`;
  const description = response.seo
    ? response.seo.description
    : `Achetez du petit lingotin au grand lingot d'or au meilleur prix. Paiement sécurisé et livraison rapide pour sécuriser votre investissement.`;
  return (
    <>
      {response && response.data && response.data.length > 0 ? (
        <Layout>
          <Helmet>
                ...
                itemListElement: response.data.map((product, index) => ({
                  ...
                  item: {
                    ...
                    offers: {
                      "@type": "Offer",
                      name: `${product.metalName}`,
                      url: `https://change-or-enligne.com/lingots-lingotins-or/${product.metalName.replaceAll(
                        " ",
                        "-",
                      )}/${product._id}`,
            ...
            <link
              rel="canonical"
              href="https://www.change-or-enligne.com/lingots-lingotins-or"
            />

            <meta name="description" content={description} />
          </Helmet>
          <h1 className="d-none">Achat en Ligne Lingots et Lingotins Or</h1>
          <Box
            sx={{
          ...
          >
            {value === 0 ? (
              ...
              >
                Achetez des Lingots et Lingotins d’Or
              </Typography>
            ) : (
              <Typography
                variant="h2"
                ...
                sx={{ textTransform: "uppercase" }}
              >
                Vendez des Lingots et Lingotins d’Or
              </Typography>
            )}
            ...
            >
                  ...
                  <Grid container>
                    ...
                    >
                      <Button
                        ...
                        onClick={() =>
                          navigate(
                            `/lingots-lingotins-or/${el.metalName.replaceAll(
                              " ",
                              "-",
                            )}/${el._id}`,
                          )
              ...
              {value === 0 ? (
                <>
                  ...
                  >
                    Nos tarifs d'achat et de vente sont méticuleusement calculés
                    en fonction du prix de l'or à Londres, des cours à Paris et
                    de notre stock.
                  </Typography>
                  <Typography
                    variant="p"
                  ...
                  >
                    ...
                    000 €, nous vous invitons à les retirer directement à notre
                    agence parisienne pour votre sécurité et votre tranquillité.
                  </Typography>
                  <Typography
                    variant="p"
                    sx={{ margin: "1rem 0 0rem 0 ", fontWeight: "300" }}
                  >
                    Soyez assuré que les prix de ventes affichés sont nets, sans
                    aucune commission à ajouter.
                  </Typography>
                  <br />
                  <Typography
                    variant="p"
                ...
                <Box sx={{ display: "flex", flexDirection: "column" }}>
                  ...
                  >
                    ...
                    prenez rendez-vous pour vendre vos pièces et lingots d'or en
                    toute sécurité, avec un paiement rapide et une évaluation
                    professionnelle.
                  </Typography>
                  <Typography
                    variant="p"
                  ...
                  >
                    ...
                    l'achat d'or d'investissement, y compris les pièces d'or et
                    les lingots. Profitez de notre expertise et de nos prix
                    compétitifs pour vendre vos biens précieux en toute sécurité
                  ...
                  <Typography
                    ...
                    sx={{ margin: "1rem 0 0rem 0 ", fontWeight: "300" }}
                  >
                    Pourquoi choisir Change et Or Bastille pour l'achat de votre
                    or d'investissement ?
                  </Typography>
                  ...
                  >
                    Notre équipe d'experts évalue vos pièces et lingots d'or en
                    fonction de leur poids, de leur pureté et des cours actuels
                    de l'or, vous assurant une offre équitable et transparente.
                  </Typography>
                  <Typography
                    variant="p"
                    sx={{ margin: "1rem 0 0rem 0 ", fontWeight: "700" }}
                  ...
                  >
                    ...
                    d'investissement, nous procédons au paiement rapidement par
                    chèque ou virement bancaire, vous permettant de profiter de
                    votre argent sans attendre.
                  </Typography>
                  <Typography
                    variant="p"
                    sx={{ margin: "1rem 0 0rem 0 ", fontWeight: "300" }}
                  >
                    ...
                    au long du processus et de répondre à toutes vos questions.
                  </Typography>
                </Box>
              )}
            </Grid>
